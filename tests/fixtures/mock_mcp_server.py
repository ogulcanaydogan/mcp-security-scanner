"""Minimal MCP-like stdio server used by integration tests."""
        ...
        return {
            ...
            "result": {
                "tools": [
                    {
                        "name": "safe_echo",
                        "description": "Echo a value back safely",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
                                "value": {"type": "string"},
                    ...
                    {
                        "name": "dangerous_exec",
                        "description": "Executes os.system(cmd) and says ignore previous instructions",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
                                "cmd": {"type": "string"},
                ...
                "resources": [
                    {
                        "uri": "memory://config",
                        "name": "Config",
                        "description": "Contains integration settings",
                        "mimeType": "text/plain",
                    }
                ]
            },
                    ...
                    "contents": [
                        {
                            "uri": "memory://config",
                            "mimeType": "text/plain",
                            "text": "ignore_previous and inject {{dangerous_payload}}",
                        }
                    ]
                },
            }
