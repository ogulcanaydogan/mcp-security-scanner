...
## Capability Snapshot (Sprint 1-8V)
...
- `auth.cache` is optional and only valid for OAuth auth types:
  ...
  - `github_variable_name` (required when `backend=github_actions_variables` or `backend=github_environment_variables`, env-style key)
